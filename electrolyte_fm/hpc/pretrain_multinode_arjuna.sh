...
#SBATCH --mem-per-cpu=3200         # memory per cpu-core (4G per cpu-core is default)
...
srun python /home/anoushkb/electrolyte_fm/electrolyte_fm/training/mlm_pretraining.py